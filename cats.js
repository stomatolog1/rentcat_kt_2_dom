...
if(cats[i].favourite){document.getElementById(`${i}`).querySelector(".favourite").innerHTML = '<img src="Heart_corazón.svg.webp" width="40px" height="40px"> ';}
else {document.getElementById(`${i}`).querySelector(".favourite").innerHTML = '<img src="trafaret-papik-pro-dt3h-p-trafareti-pustoe-serdtse-1.jpg"  width="40px" height="40px"> '}
